...
from object_dimensions.utils import compute_rdm, fill_diag
...
behavior_embedding = np.loadtxt(
    "../../learned_embeddings/weights_things_behavior_256bs/params/pruned_q_mu_epoch_3000.txt"
)
vgg_embedding = np.loadtxt(
    "../../learned_embeddings/weights_vgg_12_512bs/params/pruned_q_mu_epoch_150.txt"
)
