...
"""This is the main visualization module for representational embeddings inferred from 
triplets behavior"""
...
def parse_args():
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help="If to replace behavior images with plus images",
    )
...
def plot_dim(images, codes, dim, top_k=10, filter_plus=False, filter_behavior=False):
    # Check if codes is 2d or 1d
    if len(codes.shape) == 1:
        weight = codes
    else:
