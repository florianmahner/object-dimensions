...
def cross_correlate(args):
    ...
    plt.savefig("../plots/cross_correlation_spose_vice_triplets_behavior_256bs.png", dpi=300)
...
if __name__ == "__main__":
    ...
    args.embedding_1 = "../learned_embeddings/spose_embedding_66d_sorted.txt"
    # args.embedding_2 = "../learned_embeddings/weights_things_behavior_8196bs_adaptive_half/params/pruned_q_mu_epoch_5000.txt"
    args.embedding_2 = "../learned_embeddings/weights_things_behavior_256bs/params/pruned_q_mu_epoch_3000.txt"
    # args.embedding_2 = "../learned_embeddings/weights_things_behavior_256bs/params/pruned_q_mu_epoch_3000.txt"
